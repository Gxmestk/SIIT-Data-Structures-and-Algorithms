public class Sorting {
    ...
    //Ex2 Complete the method InsertionSort 1
    /*static void InsertionSort(int[] A) {
       for (int i = 1; i < A.length; i++)
       {
    	   ...
    	   while (j >= 0 && A[j] > tmp)
    	   {
    		   A[j + 1] = A[j];//this is better than above
    		   printArray(A);
    		   j--;
    	   }
    	   A[j + 1] = tmp;
  ...
  //Ex2 Complete the method InsertionSort 2
    /*static void InsertionSort(int[] A) {
       for (int i = 1; i < A.length; i++)
       {
    	   int	j;
    ...
    //Ex2 Complete the method InsertionSort 3
    static void InsertionSort(int[] A) {
        for (int i = 1; i < A.length; i++)
        {
        	for (int j = 0; j< i; j++) 
